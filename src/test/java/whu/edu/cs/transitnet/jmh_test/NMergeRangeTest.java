...
public class NMergeRangeTest {

    private HistoricalRangeService_nomerge Service; // 不再使用 @Autowired 注入
    ...
    public void setup() throws ParseException {
        ...
        Service = ctx.getBean(HistoricalRangeService_nomerge.class);
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(NMergeRangeTest.class.getSimpleName())
                .forks(1)
                .build();
